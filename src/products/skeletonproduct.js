export const skeletonprodut =()=>{
    const div = document.createElement("div");
    div.innerHTML =`<div role="status" class="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
